...
public class LanguageModelTest {
    ...
    private LanguageModel unigram;
    private LanguageModel bigram;
    private LanguageModel trigram;

    @Before
    public void setUp() throws Exception {
        unigram = new LanguageModel(1);
        bigram = new LanguageModel(2);
        trigram = new LanguageModel(3);
